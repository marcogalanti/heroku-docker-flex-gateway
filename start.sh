...
if [ -v REDIS_URL ]; then
    ...
    #This regular expression is used to parse and extract information from Heroku Key-Value Store connection string in the format "rediss://user:password@host:port".
    #
